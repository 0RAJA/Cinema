...
CloudflareApps.siteId = "4905307b29c9c7cd619ccb1181ff48de";
...
CloudflareApps.installs["CWVnZQm9N5A8"] = {appId: "IBLvJqG1JWkM", scope: {}};
;CloudflareApps.installs["CWVnZQm9N5A8"].options = {"website_id": "2e0c1e5e-7985-445d-b996-eaaef085041f"};
;CloudflareApps.installs["CWVnZQm9N5A8"].URLPatterns = ["^ardentri.racernet.name/?.*$", "^www.racernet.name/?.*$"];
;
if (CloudflareApps.matchPage(CloudflareApps.installs['CWVnZQm9N5A8'].URLPatterns)) {
    "use strict";
    (function () {
        var options = CloudflareApps.installs['CWVnZQm9N5A8'].options;
